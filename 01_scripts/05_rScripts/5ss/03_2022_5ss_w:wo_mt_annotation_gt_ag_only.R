...
#in_5_1_m <- read.table(file = "5-1_t_q60_sorted_pairend_mt_info_S.juncbed_intron.annotation",header = TRUE)
#in_5_2_m <- read.table(file = "5-2_t_q60_sorted_pairend_mt_info_S.juncbed_intron.annotation",header = TRUE)
#in_5_3_m <- read.table(file = "5-3_t_q60_sorted_pairend_mt_info_S.juncbed_intron.annotation",header = TRUE)
...
#t1_ori <- exon_m[which(str_detect(exon_m$id,pattern = "5_1")),]
#t2_ori <- exon_m[which(str_detect(exon_m$id,pattern = "5_2")),]
#t3_ori <- exon_m[which(str_detect(exon_m$id,pattern = "5_3")),]
...
for (i in 1:nrow(t1_ori)){
  if (str_detect(t1_ori$splice_site[i], fixed("gt-ag", ignore_case=TRUE))){t1_ori$strand_add[i] <- "+"; t1_ori$splice_site_add[i] <- "GT-AG/CT-AC"}
  else if (str_detect(t1_ori$splice_site[i], fixed("ct-ac", ignore_case=TRUE))){t1_ori$strand_add[i] <- "-"; t1_ori$splice_site_add[i] <- "GT-AG/CT-AC"}
  print(i)
} 

for (i in 1:nrow(t2_ori)){
  if (str_detect(t2_ori$splice_site[i], fixed("gt-ag", ignore_case=TRUE))){t2_ori$strand_add[i] <- "+"; t2_ori$splice_site_add[i] <- "GT-AG/CT-AC"}
  else if (str_detect(t2_ori$splice_site[i], fixed("ct-ac", ignore_case=TRUE))){t2_ori$strand_add[i] <- "-"; t2_ori$splice_site_add[i] <- "GT-AG/CT-AC"}
  print(i)
} 

for (i in 1:nrow(t3_ori)){
  if (str_detect(t3_ori$splice_site[i], fixed("gt-ag", ignore_case=TRUE))){t3_ori$strand_add[i] <- "+"; t3_ori$splice_site_add[i] <- "GT-AG/CT-AC"}
  else if (str_detect(t3_ori$splice_site[i], fixed("ct-ac", ignore_case=TRUE))){t3_ori$strand_add[i] <- "-"; t3_ori$splice_site_add[i] <- "GT-AG/CT-AC"}
  print(i)
} 
...
View(result) 
write.table(result, quote= FALSE,file = "norm_spliced_5_1_gtag_only.bed",
            sep="\t",
...
result$end <- result$end-1
View(result) 
write.table(result, quote= FALSE,file = "norm_spliced_5_2_gtag_only.bed",sep="\t",row.names= FALSE,col.names = TRUE)
...
result$end <- result$end-1
View(result) 
write.table(result, quote= FALSE,file = "norm_spliced_5_3_gtag_only.bed",sep="\t",row.names= FALSE,col.names = TRUE)
...
ti_n_ori <- read.table(file = "5-1_S4_q60_sorted_pairend_no_mt_info_S.juncbed_exon.annotation",header = TRUE)
...
#ti_n_ori <- exon_n[which(str_detect(exon_n$id,pattern = "5_1")),]
#t2_n_ori <- exon_n[which(str_detect(exon_n$id,pattern = "5_2")),]
#t3_n_ori <- exon_n[which(str_detect(exon_n$id,pattern = "5_3")),]

ti_n_ori$strand_add <- ti_n_ori$strand
ti_n_ori$splice_site_add <- ti_n_ori$splice_site
...
for (i in 1:nrow(t2_n_ori)){
  if (str_detect(t2_n_ori$splice_site[i], fixed("gt-ag", ignore_case=TRUE))){t2_n_ori$strand_add[i] <- "+"; t2_n_ori$splice_site_add[i] <- "GT-AG/CT-AC"}
  else if (str_detect(t2_n_ori$splice_site[i], fixed("ct-ac", ignore_case=TRUE))){t2_n_ori$strand_add[i] <- "-"; t2_n_ori$splice_site_add[i] <- "GT-AG/CT-AC"}
  print(i)
} 

for (i in 1:nrow(t3_n_ori)){
  if (str_detect(t3_n_ori$splice_site[i], fixed("gt-ag", ignore_case=TRUE))){t3_n_ori$strand_add[i] <- "+"; t3_n_ori$splice_site_add[i] <- "GT-AG/CT-AC"}
  else if (str_detect(t3_n_ori$splice_site[i], fixed("ct-ac", ignore_case=TRUE))){t3_n_ori$strand_add[i] <- "-"; t3_n_ori$splice_site_add[i] <- "GT-AG/CT-AC"}
  print(i)
} 
...
result$end <- result$end-1
View(result) 
write.table(result, quote= FALSE,file = "norm_spliced_no_mt_5_1_gtag_only.bed",sep="\t",row.names= FALSE,col.names = TRUE)
...
result$end <- result$end-1
View(result) 
write.table(result, quote= FALSE,file = "norm_spliced_no_mt_5_2_gtag_only.bed",sep="\t",row.names= FALSE,col.names = TRUE)
...
result$end <- result$end-1
View(result) 
write.table(result, quote= FALSE,file = "norm_spliced_no_mt_5_3_gtag_only.bed",sep="\t",row.names= FALSE,col.names = TRUE)
