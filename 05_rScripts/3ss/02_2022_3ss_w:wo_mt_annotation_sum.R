...
View(result) 
write.table(result, quote= FALSE,file = "norm_spliced_3_1.bed",sep="\t",row.names= FALSE,col.names = TRUE)
...
result$end <- result$end-1
View(result) 
write.table(result, quote= FALSE,file = "norm_spliced_3_2.bed",sep="\t",row.names= FALSE,col.names = TRUE)
...
result$end <- result$end-1
View(result) 
write.table(result, quote= FALSE,file = "norm_spliced_3_3.bed",sep="\t",row.names= FALSE,col.names = TRUE)
...
result$end <- result$end-1
View(result) 
write.table(result, quote= FALSE,file = "norm_spliced_no_mt_3_1.bed",sep="\t",row.names= FALSE,col.names = TRUE)
...
result$end <- result$end-1
View(result) 
write.table(result, quote= FALSE,file = "norm_spliced_no_mt_3_2.bed",sep="\t",row.names= FALSE,col.names = TRUE)
...
result$end <- result$end-1
View(result) 
write.table(result, quote= FALSE,file = "norm_spliced_no_mt_3_3.bed",sep="\t",row.names= FALSE,col.names = TRUE)
