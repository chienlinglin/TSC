...
qcoutputPath=${projectPath}3ss_qc/
recordPath=${projectPath}3ss_qc/summary/
...
do 
  ...
  trimmomatic \
          ...
          ILLUMINACLIP:/home/cllin/splice_seq/NextEra.fa:0:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:20 HEADCROP:3 MINLEN:100
done
