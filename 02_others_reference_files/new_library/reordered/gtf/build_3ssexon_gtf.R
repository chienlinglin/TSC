...
write.table(pre_gff2, file = "3ss_exon_tmp.gtf", quote = FALSE, sep = "\t", row.names = FALSE, col.names = FALSE)
tmp <- import.gff2("3ss_exon_tmp.gtf")

export.gff2(tmp, "3ss_exon.gtf")
